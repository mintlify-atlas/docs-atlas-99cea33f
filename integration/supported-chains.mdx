...
Bridge Wrapped supports over 100 blockchain networks across EVM and non-EVM ecosystems. Chain information is centrally managed in `src/services/chains/chainInfo.ts`.
