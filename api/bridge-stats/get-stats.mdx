...
```bash cURL
curl -X GET "https://yourdomain.com/api/bridge-stats/0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb?year=2025" \
...
const response = await fetch(
  `https://yourdomain.com/api/bridge-stats/${address}?year=${year}`
);
...
response = requests.get(
    f"https://yourdomain.com/api/bridge-stats/{address}",
    params={"year": year}
)
